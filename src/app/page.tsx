    ...
    <main className="flex flex-grow flex-col p-6 w-full max-w-[800px] space-y-6">
      ...
      <div className="grid grid-cols-5 gap-4">
        <div className="col-span-4 pr-8">
          ...
          <div className="rounded w-full bg-gray-200 h-2.5">
            <div className="rounded bg-cyan-200 h-2.5 w-1/2"></div>
          </div>
          {/* Schedule, slides, meeting location */}
          <div className="md:grid md:grid-cols-3 w-full border-b border-gray-600 font-bold pt-6">
            <p>Date</p>  
            {/* get class activity to fill space */}
